//taken from https://github.com/adamschwartz/web.scraper.workers.dev/blob/master/scraper.js
//added function getHrefs to get all hrefs of links on a page
  ...
  async getHrefs() {
    ...
    selectors.forEach((selector) => {
      ...
      this.rewriter.on(selector, {
        element(element) {
          nextHref = element.getAttribute('href');
          matches[selector].push(nextHref);
          nextHref = '';
        },
      });
